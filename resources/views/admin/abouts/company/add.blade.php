                ...
                <div class="card">
                    <div class="card-body">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="about_companyCode">Year <span class="required">*</span></label>
                                        <input type="text" name="about_company_year" class="form-control" id="about_companyCode" placeholder="Year" value="{{@$about_company->about_company_year}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
