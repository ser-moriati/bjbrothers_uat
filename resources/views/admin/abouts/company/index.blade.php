                                        ...
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="elm1">ธุรกิจของเรา</label>
                                                        <textarea class="summernote" id="elm1">{{@$about->business}}</textarea>
                                                        <input type="hidden" id="business" name="business" value="{{@$about->business}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-file">
                                                            <input name="chart" type="file" class="custom-file-input" id="customFile" accept="image/*" onchange="imgChange(this)" value="{{@$about->chart}}" @empty($about->chart) required @endempty >
                                                            <label class="custom-file-label" for="customFile">@isset($about->chart) {{$about->chart}} @else Choose Picture @endisset</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <img class="img-thumbnail imagePreview"@if(!isset($about->chart)) style="display: none;" @endif alt="200x200" width="200" src="{{ URL::asset('upload/about/'.@$about->chart) }}" data-holder-rendered="true">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="elm1">โรงงานของเรา</label>
                                                        <textarea class="summernote2" id="elm1">{{@$about->factory}}</textarea>
                                                        <input type="hidden" id="factory" name="factory" value="{{@$about->factory}}">
                                                    </div>
                                                </div>
                                                {{-- <div class="col-md-6">
                                                    <div class="form-group">
                        ...
                        <table class="table table-centered table-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>{{$num++}}</td>
                                    <td>{{$value->about_company_year}}</td>
                                    <td>@empty(!$value->about_company_detail){{iconv_substr($value->about_company_detail, 0, 40, "UTF-8")}}...  @endempty</td>
