                        ...
                        <input type="hidden" name="id" id="id" value="{{@$users->id}}">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="shippingName">ระดับพนักงาน <span class="required">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="shippingName">Email <span class="required">*</span></label>
                                        <input type="text" name="email" class="form-control" id="email" placeholder="name" value="{{@$users->email}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="shippingName">password <span class="required">*</span></label>
