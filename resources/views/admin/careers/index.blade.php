...
@section('title') CareerKs @endsection
                        ...
                        <div class="col-sm-9">
                            <form method="GET" action="">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    ...
                                    <input type="search" class="form-control" name="position" placeholder="position..." value="{{@$query['position']}}">
                                        {{-- <i class="fas fa-times search-icon"></i> --}}
                                    </div>
                                </div>
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    <div class="position-relative">
                                        <input type="search" class="form-control" name="description" placeholder="description..." value="{{@$query['description']}}">
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        {{-- <img src="{{URL::asset('upload/'.$page_url)}}/{{$value->banner}}" alt=""> --}}
                                        <a class="float-left" href="{{URL::asset('upload/'.$page_url)}}/{{$value->banner}}" title="{{$value->product_name}}"><img width="50px" src="{{URL::asset('upload/'.$page_url)}}/{{$value->banner}}" alt="" width="275"></a>
                                        </div>
                                    </td>
                                    <td>{{$value->position}}</td>
                                    <td>@empty(!$value->description){{iconv_substr(str_replace("|i|"," | ",$value->description), 0, 40, "UTF-8")}}...  @endempty</td>
                                    <td>
                                        {{$value->created_at}}
                                    </td>
                                    <td>
