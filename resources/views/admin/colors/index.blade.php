                        ...
                        <div class="col-sm-9">
                            <form method="GET" action="{{$page_url}}">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    ...
                                    <input type="search" class="form-control" name="color_name" placeholder="name..." value="{{@$query['color_name']}}">
                        ...
                        <table class="table table-centered table-nowrap">
                            ...
                            <tbody align="center">
                                ...
                                <tr>
                                    ...
                                    <td>{{$num++}}</td>
                                    <td><div class="color-box" style="background-color:{{$value->color_code}};width: 20px;height: 20px;"></div></td>
