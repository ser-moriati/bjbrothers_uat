...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <form id="newsForm" action="{{url('admin/contact/insert')}}" method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Picture Social icon<span class="required">* The image size must not exceed 2 MB.</span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{pathinfo(@$news->title_image, PATHINFO_FILENAME)}}" id="nameImg" name="title" required>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Picture <span class="required">* The image size must not exceed 2 MB.</span></label>
                                            <div class="custom-file">
                                                <input name="title_image1" type="file" class="custom-file-input1" id="customFile1" accept="image/*" onchange="imgChange1(this)" value="{{@$news->title_image1}}" @empty($news->title_image1) required @endempty >
                                                <label class="custom-file-label" for="customFile1">@isset($news->title_image1) {{$news->title_image1}} @else Choose Picture @endisset</label>
                                            </div>
                                        <!-- <span class="required"> &nbsp; Suitable scale 800 x 533 pixels.</span> -->
                                    </div>
                                    <div class="form-group">
                                        <label for="nameImg">Name image <span class="required">*</span></label>
                                        <input type="text" class="form-control" value="{{pathinfo(@$news->title_image, PATHINFO_FILENAME)}}" id="nameImg" name="title_image_name1" required>
                                    </div>
                                 
                                        {{-- <div class="col-md-12"> --}}
                                            <div class="form-group">
                                                <img class="img-thumbnail imagePreview1"@if(!isset($news->title_image1)) style="display: none;" @endif alt="200x200" width="200" src="{{ URL::asset('upload/news/'.@$news->title_image1) }}" data-holder-rendered="true">
                                            </div>
                                        {{-- </div> --}}
                                    </div>
                                </div>
