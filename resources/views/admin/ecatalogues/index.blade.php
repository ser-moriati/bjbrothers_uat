                            ...
                            <form method="GET" action="{{$page_url}}">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    <div class="position-relative">
                                        <input type="search" class="form-control" name="ecatalogue_name" placeholder="name..." value="{{@$query['ecatalogue_name']}}">
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        {{-- <img src="{{URL::asset('upload/'.$page_url)}}/{{$value->ecatalogue_image}}" alt=""> --}}
                                        <a class="float-left" href="{{URL::asset('upload/'.$page_url)}}/{{$value->ecatalogue_image}}" title="{{$value->ecatalogue_name}}"><img width="50px" src="{{URL::asset('upload/'.$page_url)}}/{{$value->ecatalogue_image}}" alt="" width="275"></a>
                                        </div>
                                    </td>
                                    <td>
                                        {{$value->ecatalogue_title}}
                                    </td>
                                    <td><a href="{{URL::asset('upload/'.$page_url.'/pdf')}}/{{$value->ecatalogue_pdf_name}}" target="_blank">{{$value->ecatalogue_pdf_name}}</a></td>
                                    <td>
                                        {{$value->created_at}}
                                    </td>
                                    <td>
