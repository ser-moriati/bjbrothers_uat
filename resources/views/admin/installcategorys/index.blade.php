                        ...
                        <div class="col-sm-9">
                            <form method="GET">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    ...
                                    <input type="search" class="form-control" name="install_category_name" placeholder="name..." value="{{@$query['install_category_name']}}">
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        {{-- <img src="{{URL::asset('upload/'.$page_url)}}/{{$value->install_category_image}}" alt=""> --}}
                                        <a class="float-left" href="{{URL::asset('upload/'.$page_url)}}/{{$value->install_category_image}}" title="{{$value->install_name}}"><img width="50px" src="{{URL::asset('upload/'.$page_url)}}/{{$value->install_category_image}}" alt="" width="275"></a>
                                        </div>
                                    </td>
                                    <td>{{$value->install_category_name}}</td>
