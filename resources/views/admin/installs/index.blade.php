                            ...
                            <form method="GET" action="{{$page_url}}">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    <div class="position-relative">
                                        <input type="search" class="form-control" name="install_name" placeholder="name..." value="{{@$query['install_name']}}">
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        {{-- <img src="{{URL::asset('upload/'.$page_url)}}/{{$value->install_image}}" alt=""> --}}
                                        <a class="float-left" href="{{URL::asset('upload/'.$page_url)}}/{{$value->install_image}}" title="{{$value->install_name}}"><img width="50px" src="{{URL::asset('upload/'.$page_url)}}/{{$value->install_image}}" alt="" width="275"></a>
                                        </div>
                                    </td>
                                    <td>{{$value->install_name}}</td>
                                    {{-- <td>@empty(!$value->install_detail){{iconv_substr(str_replace("|i|"," | ",$value->install_detail), 0, 30, "UTF-8")}}...  @endempty</td> --}}
