                    ...
                    <div class="row mb-2">
                        <div class="col-sm-9">
                            <form method="GET">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    ...
                                    <input type="search" class="form-control" name="maintenance_category_name" placeholder="name..." value="{{@$query['maintenance_category_name']}}">
                        ...
                        <div class="col-sm-3">
                            <div class="text-sm-right">
                                <a href="{{url('admin/'.$page_url.'/add')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i> Add New {{$page}}</a>
                            </div>
                        </div><!-- end col-->
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        {{-- <img src="{{URL::asset('upload/'.$page_url)}}/{{$value->maintenance_category_image}}" alt=""> --}}
                                        <a class="float-left" href="{{URL::asset('upload/'.$page_url)}}/{{$value->maintenance_category_image}}" title="{{$value->maintenance_name}}"><img width="50px" src="{{URL::asset('upload/'.$page_url)}}/{{$value->maintenance_category_image}}" alt="" width="275"></a>
                                        </div>
                                    </td>
                                    <td>{{$value->maintenance_category_name}}</td>
