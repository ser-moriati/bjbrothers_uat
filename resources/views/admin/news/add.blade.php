...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <form id="newsForm" action="{{$action}}" method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <textarea name="detail" placeholder="Detail" id="elm1">{{@$news['detail']}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="metatitle" name="meta_title" type="text" placeholder="Meta Title" class="form-control" value="{{@$news->meta_title}}">
                                </div>
                                <div class="form-group">
                                    <label for="metakeywords">Meta Keywords</label>
                                    <input id="metakeywords" name="meta_keywords" type="text" placeholder="Meta Keywords" class="form-control" value="{{@$news->meta_keywords}}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="meta_description" name="meta_description" placeholder="Meta Description" rows="5">{{@$news->meta_description}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
