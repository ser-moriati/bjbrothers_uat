                        ...
                        <input type="hidden" name="file_gallery_name" id="file_name">
                            <div class="row">
                                ...
                                <div align='left' class="col-sm-6 form-group">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="customCheck2" name="product_recommended" @if(@$product->product_recommended=='Y') checked @endif value="1">
                                    <label class="custom-control-label" for="customCheck2">Product Recommended</label>
                                    </div>
                                </div>
