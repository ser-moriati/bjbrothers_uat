                            ...
                            <form method="GET" action="{{$page_url}}">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    <div class="position-relative">
                                        <input type="search" class="form-control" name="portfolio_name" placeholder="name..." value="{{@$query['portfolio_name']}}">
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        {{-- <img src="{{URL::asset('upload/'.$page_url)}}/{{$value->portfolio_image}}" alt=""> --}}
                                        <a class="float-left" href="{{URL::asset('upload/'.$page_url)}}/{{$value->portfolio_image}}" title="{{$value->portfolio_name}}"><img width="50px" src="{{URL::asset('upload/'.$page_url)}}/{{$value->portfolio_image}}" alt="" width="275"></a>
                                        </div>
                                    </td>
                                    <td>{{$value->portfolio_category_name}}</td>
                                    <td>
                                        {{$value->created_at}}
                                    </td>
                                    <td>
