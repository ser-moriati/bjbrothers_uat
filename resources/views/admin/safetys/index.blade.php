                            ...
                            <form method="GET" action="{{$page_url}}">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    <div class="position-relative">
                                        <input type="search" class="form-control" name="safety_name" placeholder="name..." value="{{@$query['safety_name']}}">
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        <a class="float-left" href="{{URL::asset('upload/'.$page_url)}}/{{$value->safety_image}}" title="{{$value->safety_name}}"><img width="50px" src="{{URL::asset('upload/'.$page_url)}}/{{$value->safety_image}}" alt="" width="275"></a>
                                        </div>
                                    </td>
