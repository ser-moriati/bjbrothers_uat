                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="file_gallery_name" id="file_name">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="shippingName">Name <span class="required">*</span></label>
                                        <input type="text" name="shipping_name" class="form-control" id="shippingName" placeholder="name" value="{{@$shipping->shipping_name}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="shippingDetail">Detail</label>
                                        <textarea type="text" name="shipping_detail" class="form-control" id="shippingDetail" placeholder="detail">{{@$shipping->shipping_detail}}</textarea>
                                    </div>
                                </div>
                                
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="shippingSale">Shipping cost</label>
                                        <input type="number" name="shipping_sale" class="form-control" id="shippingSale" placeholder="Shipping cost" value="{{@$shipping->shipping_sale}}"  step="any">
                                    </div>
                                </div>
