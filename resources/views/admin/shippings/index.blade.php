                            ...
                            <form method="GET" action="{{$page_url}}">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    <div class="position-relative">
                                        <input type="search" class="form-control" name="shipping_name" placeholder="name..." value="{{@$query['shipping_name']}}">
                                    </div>
                                </div>
                        ...
                        <table class="table table-centered table-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>{{$value->shipping_detail}}</td>
                                    <td>{{$value->shipping_sale}}</td>
                                    <td>
