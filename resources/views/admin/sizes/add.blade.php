                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="sizeName">Size name <span class="required">*</span></label>
                                                        <input type="text" name="size_name" class="form-control" id="sizeName" value="{{@$size->size_name}}" placeholder="Size name" required>
                                                            <div class="invalid-feedback">
                                                                Please provide a valid Size name.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{-- <div class="col-md-3">
