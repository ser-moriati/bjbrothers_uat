                            ...
                            <form method="GET" action="{{$page_url}}">
                                <div class="col-sm-3 search-box mb-2 d-inline-block">
                                    <div class="position-relative">
                                        <input type="search" class="form-control" name="technical_name" placeholder="name..." value="{{@$query['technical_name']}}">
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        ...
                                        {{-- <img src="{{URL::asset('upload/'.$page_url)}}/{{$value->technical_image}}" alt=""> --}}
                                        <a class="float-left" href="{{URL::asset('upload/'.$page_url)}}/{{$value->technical_image}}" title="{{$value->technical_name}}"><img width="50px" src="{{URL::asset('upload/'.$page_url)}}/{{$value->technical_image}}" alt="" width="275"></a>
                                        </div>
                                    </td>
                                    <td>{{$value->technical_name}}</td>
                                    {{-- <td>@empty(!$value->technical_detail){{iconv_substr(str_replace("|i|"," | ",$value->technical_detail), 0, 30, "UTF-8")}}...  @endempty</td> --}}
