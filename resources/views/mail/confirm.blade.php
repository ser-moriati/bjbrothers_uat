  ...
  <table style="max-width:670px;margin:50px auto 10px;background-color:#fff;padding:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24); border-top: solid 10px green;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <!-- <p style="font-size:14px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px">แจ้งเตือน</span><b >มีคำสั่งซื้อแจ้งชำระเงินเข้ามาใหม่</b></p> -->
            <p style="font-size:14px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px">สถานะการสั่งซื้อ</span><b style="color:green;font-weight:normal;margin:0">ยืนยันรายการสั่งซื้อและแจ้งชำระเงิน</b></p>
            ...
            <!-- <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px"></span>https://www.bjbrothers.com/order/confirmPayment/{{$order->order_number}}</p> -->
      ...
      <tr>
        ...
        <td colspan="2" style="padding:15px;">
            ...
            <td style="height:45px;" colspan="3">
              <a href="https://www.bjbrothers.com/order/confirmPayment/{{$order->order_number}}" style="text-decoration: none; color: #fff; font-size: 14px;">
                <div style="background-color: #4CAF50; padding: 10px; display: inline-block; width: 100%;">
                  <center> ชำระเงิน </center>
                </div>
              </a>  
            </td>

            <td style="height:45px;" colspan="3">
              <a href="https://www.bjbrothers.com/order/cancelPayment/{{$order->order_number}}" style="text-decoration: none; color: #fff; font-size: 14px;">
                <div style="background-color: #FF0000; padding: 10px; display: inline-block; width: 100%;">
...
<!-- ... โค้ด HTML ถัดไป ... -->
    ...
    <tr>
        <td colspan="2" style="font-size:14px;padding:50px 15px 0 15px;">
          <strong style="display:block;margin:0 0 10px 0;">ช่องทางการชำระเงิน</strong> 
          @foreach ($bank as $bank) 
          <b>{{$bank->bank_name}} : </b> {{$bank->bank_number}}<br>
          @endforeach    
