    ...
    <tbody>
      ...
      <tr>
        <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
            <p style="font-size:14px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px">สถานะการสั่งซื้อ</span><b style="color:green;font-weight:normal;margin:0">ยืนยันการชำระเงินและการจัดส่งสินค้า</b></p>
            ...
            <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">หมายเหตุ</span>เรียนคุณ  {{$order->member_firstname}} {{$order->member_lastname}}  {{$order->Comment}} </p>
            <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">ประเภทขนส่ง</span> {{$order->Transport_type}}</p>
            <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">หมายเลขติดตามพัสดุ</span>{{$order->Tracking_Number}}</p>
            <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">เอกสารสารติดตามขนส่ง</span><a href="https://www.bjbrothers.com/upload/slip/{{ str_replace(' ','%20',$order->receipt) }}" download="https://www.bjbrothers.com/slip/product/{{ str_replace(' ','%20',$order->Tracking_file) }}">ดาวน์โหลด</a></p>
          </td>
      
      </tr>
      <tr>
        <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
              <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">ใบเสร็จการชำระเงิน</span><a href="https://www.bjbrothers.com/upload/slip/{{ str_replace(' ','%20',$order->receipt) }}" download="https://www.bjbrothers.com/slip/product/{{ str_replace(' ','%20',$order->receipt) }}">ดาวน์โหลด</a> </p>
        </td>
      </tr>
      <tr>
