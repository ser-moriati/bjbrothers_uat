    ...
    <tbody>
      ...
      <tr>
        <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
            <p style="font-size:14px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px">สถานะการสั่งซื้อ</span><b style="color:green;font-weight:normal;margin:0">แจ้งชำระเงิน</b></p>
      ...
      <tr>
        <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
            <p style="font-size:12px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px"> บัญชีที่โอนเงิน</span> {{$bank_name}}</p>
            <p style="font-size:12px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">จำนวนเงินที่โอน</span>  {{$order->transfer_amount}}</p>
            <p style="font-size:12px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px"> วันที่ชำระเงิน</span> {{$order->transfer_date}}</p>
            <p style="font-size:12px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">เวลาที่ชำระเงิน</span> {{$order->transfer_time}} น.</p>
      ...
      <tr>
        <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
              <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">หลักฐานการชำระเงิน</span><a href="https://www.bjbrothers.com/upload/slip/{{ str_replace(' ','%20',$order->transfer_image) }}" download="https://www.bjbrothers.com/upload/slip/{{ str_replace(' ','%20',$order->transfer_image) }}">ดู</a> </p>
        </td>
      </tr>
