    ...
    <tbody>
      ...
      <tr>
        <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
            <p style="font-size:14px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px">สถานะการสั่งซื้อ</span><b style="color:green;font-weight:normal;margin:0">ขอบคุณที่ชำระเงิน</b></p>
            ...
            <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">หมายเหตุ</span>เรียนคุณ  {{$order->member_firstname}} {{$order->member_lastname}} ทางเราได้รับหลักฐานการชำระเงินของคุณแล้ว กรุณารอการยืนยันการชำระเงินจากทางเราอีกครั้ง </p>
            <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">ข้อมูลในการติดต่อ</span> เบอร์โทร 064-592-4655 ไลน์ไอดี <a href="https://page.line.me/moz3566f?openQrModal=true">@bjbrothers</a></li></p>
          </td>
      </tr>
      <!-- <tr>
        <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
            <p style="font-size:12px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px"> บัญชีที่โอนเงิน</span><b style="color:green;font-weight:normal;margin:0">แจ้งชำระเงิน</b></p>
            <p style="font-size:12px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">จำนวนเงินที่โอน</span> {{$order->order_number}}</p>
            <p style="font-size:12px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px"> วันที่ชำระเงิน</span><b style="color:green;font-weight:normal;margin:0">แจ้งชำระเงิน</b></p>
            <p style="font-size:12px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">เวลาที่ชำระเงิน</span> {{$order->order_number}}</p>
            
            <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">ลิ้งก์การชำระเงิน</span>https://www.bjbrothers.com/order/confirmPayment/{{$order->order_number}}</p> -->
        <!-- </td>
        <td style="border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"><img src="https://www.bjbrothers.com/images/LOGO-BJ.png" alt="รูปภาพสินค้า" style="max-width: 50px;"></td> -->
      ...
      <tr>
        ...
        <td colspan="2" style="padding:15px;">
            ...
            <tr>
                    <td style="border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:left;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:left;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"> </td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;">ค่าขนส่ง</td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;">{{$order->shipping_cost}} </td>
            </tr>
            <tr>
                    <td style="border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:left;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:left;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"> </td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;">ภาษี</td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;">{{$order->vat}} </td>
            </tr>
            <tr>
                    <td style="border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:left;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:left;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"> </td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;"></td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;">ราคารวมสุทธิ</td>
                    <td style="text-align:right;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;">{{number_format($sum+$order->vat+$order->shipping_cost, 2)}}</td>
            </tr>
            </tbody>
            </table>
        </td>
