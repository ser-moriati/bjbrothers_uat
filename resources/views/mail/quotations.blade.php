    ...
    <tbody>
      ...
      <tr>
        ...
        <p style="font-size:12px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">หมายเลขใบขอเสนอราคา</span> {{$order->number}}</p>
          <p style="font-size:12px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">หมายเหตุ</span>เรียนคุณ  {{$order->member_firstname}} {{$order->member_lastname}} ทางเราได้รับข้อมูลขอใบเสนอราคาของท่านแล้ว กรุณารอทางเราติดต่อกลับไปอีกครั้ง </p>
        ...
        <td colspan="2" style="padding:15px;">
            ...
            @foreach ($order->quotation_details as $item)
                ...
                <tr>
                    ...
                    <td style="text-align:left;border-bottom: 1px solid black;padding-bottom: 5px;padding-top: 5px;">@php $productcode = DB::table('productsku')->where('id',@$item->product_SKU_id)->first(); @endphp {{@$productcode->product_SKU}} </td>
