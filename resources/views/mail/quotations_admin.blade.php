  ...
  <table style="max-width:670px;margin:50px auto 10px;background-color:#fff;padding:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24); border-top: solid 10px green;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <p style="font-size:14px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:150px">สถานะ</span><b style="color:green;font-weight:normal;margin:0">ขอใบเสนอราคา</b></p>
          <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">หมายเลขใบขอเสนอราคา</span> {{$order->number}}</p>
          <!-- <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">หมายเหตุ</span>เรียนคุณ  {{$order->member_firstname}} {{$order->member_lastname}} ทางเราได้รับข้อมูลขอใบเสนอราคาของท่านแล้ว กรุณารอทางเราติดต่อกลับไปอีกครั้ง </p> -->
          <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">จัดการ</span> <a href="https://www.bjbrothers.com/admin/quotation?quotation_number={{$order->number}}&customer_name=" >ตรวจสอบข้อมูล </a></p>
        </td>
      </tr>
      <tr>
        <td style="height:35px;"></td>
