                ...
                <div class="row">
                    <div class="col">
                        <ul class="bread-crumb">
                            ...
                            <li>{{$cate->technical_category_name}}</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="content-padding pad-foot">
        <div class="container-fluid">
            <div class="wrap-pad">
                ...
                <div class="row">
                    <div class="col">
                        <h2 class="text-center mb-4">Technical Tips</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-9 col-md-8 col-12">
                        <h4 class="gray">{{$cate->technical_category_name}}</h4>
                    </div>
                ...
                <div class="box-padding">
                    <div class="row">
                        @foreach ($technical as $safe)                            
                        <div class="col-lg-4 col-md-4 col-6">
                            <a class="knowBox" href="{{url('technical/'.$cate_id.'/'.$safe->id)}}">
                                <div class="know-img"><img src="{{ asset('upload/technical').'/'.$safe->technical_image}}"></div>
                                <div class="download-topic">
                                    <p>{{$safe->technical_name}}</p>
                                </div>
                            </a> 
                        </div>
                        @endforeach
